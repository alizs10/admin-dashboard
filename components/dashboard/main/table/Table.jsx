...
function Table() {
    return (
        <table className="w-full table table-auto border-collapse border shadow-md rounded-md overflow-hidden">

            <thead>
                <tr className="bg-white text-left">
                    <th className="capitalize px-5 py-3 border border-slate-300">#</th>
                    <th className="capitalize px-5 py-3 border border-slate-300">title</th>
                    <th className="capitalize px-5 py-3 border border-slate-300">status</th>
                    <th className="capitalize px-5 py-3 border border-slate-300">actions</th>
                </tr>
            </thead>
            <tbody>

                <tr className="odd:bg-slate-200 even:bg-slate-100">
                    <td className="px-5 py-3 border border-slate-300">1</td>
