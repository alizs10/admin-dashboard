        ...
        <section>
            <Form>
                ...
                <div className="mt-4 pb-20 col-span-2 flex justify-end items-center gap-x-2">
                    <button className="px-4 py-2 rounded-md bg-slate-100 text-slate-500 text-lg shadow-md flex gap-x-2 items-center">
                        <div className="w-4 h-4">
                            <ArrowPathIcon />
                        </div>
                        <span>Reset</span>
                    </button>
                    <button className="px-4 py-2 rounded-md bg-blue-100 text-blue-500 text-lg shadow-md flex gap-x-2 items-center">
                        <div className="w-4 h-4  fill-blue-500">
                            <SaveIcon />
                        </div>
                        <span>
                            Save
